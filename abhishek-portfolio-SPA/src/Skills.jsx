  ...
  return (
    <>
      <div className=" my-3 col-6 w-100">
        <div className="card main-skills mx-3">
          <h2 className="header-main-skills text-center">My Skills</h2>
      ...
      <div className="my-3 col-6">
        <div className="card language-main-skills ms-3">
          <h2 className="header-main-skills w-100 text-center">My Languages</h2>
